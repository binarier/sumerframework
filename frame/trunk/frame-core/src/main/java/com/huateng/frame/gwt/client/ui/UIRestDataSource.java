...
import org.synthful.smartgwt.client.widgets.UIDataSource;
...
public class UIRestDataSource extends UIDataSource
{
	...
	public UIRestDataSource(String dispatcherContext, String controllerMapping)
	{
		...
		datasource.setOperationBindings(new OperationBinding(DSOperationType.FETCH, url + "fetch"), new OperationBinding(DSOperationType.ADD, url + "add"),
				new OperationBinding(DSOperationType.UPDATE, url + "update"), new OperationBinding(DSOperationType.REMOVE, url + "remove"));
	}
...
//	}
	...
	public Criteria convertRelativeDates(Criteria criteria, String timezoneOffset, int firstDayOfWeek)
	{
		return datasource.convertRelativeDates(criteria, timezoneOffset, firstDayOfWeek);
	}
	...
	{
		datasource.performCustomOperation(operationId, data, callback, requestProperties);
	}
	...
	public void addData(Record record, DSCallback callback, DSRequest requestProperties)
	{
	...
	public void updateData(Record record, DSCallback callback, DSRequest requestProperties)
	{
